...
export const metadata: Metadata = {
  ...
  openGraph: { title: "trustset · An off switch for AI agents", description: "One transaction from a cold key, and every app that checks refuses the agent in the next block.", url: "https://trustset.silknodes.io", siteName: "trustset · by silk nodes", type: "website", locale: "en_US", images: [{ url: "/og.png", width: 1280, height: 640, alt: "agent 7 REFUSED: paused by its owner, and may come back" }] },
  twitter: { card: "summary_large_image", title: "trustset · An off switch for AI agents", creator: "@silk_nodes", site: "@silk_nodes", images: ["/og.png"] },
};
